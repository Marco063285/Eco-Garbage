...
export default function NewRequest() {
  ...
  const SERVICE_TYPES = [
    ...
    { value: 'recyclable', label: isEn ? '?? Recyclables': '?? Recyclables',desc: isEn ? 'Recyclable materials'  : 'Matières recyclables' },
  ]
  ...
  const getLocation = () => {
    if (!navigator.geolocation) return toast.error(isEn ? 'Geolocation not supported' : 'Géolocalisation non supportée')
    setLocating(true)
